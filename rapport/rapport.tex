...
Dans le cadre du module de Software Engineering 2025, il nous a été demandé de réaliser un projet individuel
...
deux entiers consécutifs, et une qui ne le permet pas. Le projet inclut également la gestion des zones de
débordement pour optimiser les valeurs extrêmes et des benchmarks pour évaluer les gains de performance.
